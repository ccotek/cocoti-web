...
export const APP_CONFIG = {
  ...
  TERMS_URL: process.env.NEXT_PUBLIC_TERMS_URL || 'https://cocoti.app/terms-of-service',
  PRIVACY_URL: process.env.NEXT_PUBLIC_PRIVACY_URL || 'https://cocoti.app/privacy-policy',
};
