        ...
        <div className="grid gap-4">
          {faq.items && Array.isArray(faq.items) && faq.items.map((item, index) => (
            ...
            >
              ...
              >
                <span className="text-sm font-semibold text-night leading-relaxed">{item.question}</span>
                <motion.span
              ...
              <AnimatePresence initial={false}>
                {openIndex === index && (
                  <motion.div
                    className="px-6 pb-5 text-sm md:text-base text-ink-muted leading-relaxed"
