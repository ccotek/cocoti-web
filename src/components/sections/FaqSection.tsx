...
export default function FaqSection({ faq, locale }: FaqSectionProps) {
  ...
  const whatsappMessage = faq.whatsappMessage || translate("whatsapp.defaultMessage", locale);
          ...
          >
            <div className="group relative rounded-[2.5rem] border border-cloud/50 bg-white/60 p-8 md:p-10 shadow-2xl shadow-night/[0.03] backdrop-blur-xl transition-all duration-500 hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold text-night mb-4">
                {faq.cta?.title || translate("faq.cta.title", locale)}
              </h3>
              <p className="text-ink-muted mb-8 text-base leading-relaxed">
                {faq.cta?.description || translate("faq.cta.description", locale)}
              </p>
              ...
              >
                ...
                {faq.cta?.whatsapp || translate("faq.cta.whatsapp", locale)}
              </motion.a>
            </div>
          </motion.div>
        </div>
