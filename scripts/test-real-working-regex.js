...
console.log('Regex qui fonctionne vraiment:', realWorkingRegex);
console.log('Match:', testLine.match(realWorkingRegex));
...
console.log('\nRegex qui fonctionne vraiment vraiment:', realRealWorkingRegex);
console.log('Match vraiment vraiment:', testLine.match(realRealWorkingRegex));
